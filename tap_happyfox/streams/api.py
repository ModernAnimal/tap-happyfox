...
def happyfox_api(api_key, api_code, category, page_num):
    ...
    paginated_url = (
        f"https://support.modernanimal.com/api/1.1/json/tickets/?category={category}size={page_size}&page={page_num}"
    )
